...
- [ ] **PS-01** Sankey "money flow" diagram (Income → Category) — M · `app/src/features/analytics/screens/MoneyFlow.js`, `app/src/analytics/flow.js`
...
- [ ] **PS-02** Mood × Spend analytics screen — S · `app/src/features/analytics/screens/MoodSpend.js`, `app/src/analytics/mood.js`
...
- [ ] **PS-03** Carbon footprint dashboard screen — M · `app/src/features/analytics/screens/CarbonDashboard.js`
...
- [ ] **PS-04** Net worth donut + assets-vs-liabilities breakdown view — S · `app/src/features/accounts/screens/NetWorth.js` (existing screen extension)
...
- [ ] **PS-05** Global month / date-range selector on Home + Trends — M · `app/src/components/primitives/MonthPicker.js`, `app/src/features/home/screens/Home.js`, `app/src/features/trends/screens/Trends.js`
...
- [ ] **PS-06** Dedicated Budget Setup overview screen — M · `app/src/features/categories/screens/BudgetSetup.js`
...
- [ ] **PS-07** Trip expense detail screen — M · `app/src/features/travel/screens/TripDetail.js`
...
- [ ] **PS-08** Notification Center / in-app activity feed — M · `app/src/features/notifications/screens/Activity.js`
...
- [ ] **PS-09** User-defined Quick-Entry Templates — M · `app/src/features/expenses/screens/QuickTemplates.js`, migration v33 (new table `expense_templates`)
...
- [ ] **PS-10** Investment holdings + manual NAV snapshot tracker — XL · migration v33, `app/src/features/investments/{repo,context,screens}/*`
...
- [ ] **PS-11** Insurance premium tracker — L · migration v33, `app/src/features/insurance/{repo,context,screens}/*`
...
- [ ] **PS-12** Loan tax-benefit (80C / 24B) + prepayment simulator — L · `app/src/features/emi/screens/{EMI,TaxBenefit}.js`
...
- [ ] **PS-13** FASTag transaction tracking — L · migration v33, `app/src/features/fastag/{repo,context,screens}/*`
...
- [ ] **PS-14** ITR / tax-year export bundle — S · `app/src/features/expenses/screens/Export.js` (existing extension)
...
- [ ] **PS-15** Android launcher app shortcuts — S · `app/android/app/src/main/AndroidManifest.xml`, `app/android/app/src/main/res/xml/shortcuts.xml`, `app/src/navigation/index.js`
...
- [ ] **PS-16** Share-target intent (Gallery → Drift creates draft scan) — M · `app/android/app/src/main/AndroidManifest.xml`, `app/src/features/scan/ScanService.js`
...
- [ ] **PS-17** Android home-screen widget — XL · new native module `app/android/app/src/main/java/.../DriftWidgetProvider.kt`
...
- [ ] **PS-18** Adopt TypeScript across `features/` incrementally — XL · `app/tsconfig.json`, `app/babel.config.js`, per-feature `.ts` files
...
- [ ] **PS-19** Jest test runner + golden tests for analytics/OCR/repos — XL · `app/jest.config.js`, `app/__tests__/**`
...
- [ ] **PS-20** ESLint dependency-layer rules (enforce ocr/, core/, features/ boundaries) — M · `app/.eslintrc.cjs`, `app/.eslint-plugin-drift/`
...
- [ ] **PS-21** Privacy mask mode + FLAG_SECURE + amount peek-resistance — M · `app/android/.../MainActivity.kt`, `app/src/features/profile/screens/Profile.js`, `app/src/core/state/PrivacyContext.js`
